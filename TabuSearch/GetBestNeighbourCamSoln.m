...
BestNeighbourSoln = Soln;
BestNeighbourSolnCost = Inf;
        ...
        for j = 1:MaxLength
            for dir = 1:2
                ...
                if i ~= Soln(cam, 1) || j ~= Soln(cam, 2) || dir ~= Soln(cam, 3)
                    ...
                    if NewSolnCost < BestNeighbourSolnCost
                        TabuCam = cam;
                        BestNeighbourSolnCost = NewSolnCost;
                        BestNeighbourSoln = NewSoln;
                    end
                end
            end
        end
...
if TabuCam ~= -1
    ...
    TabuCameras(TabuCam) = TabuLength;
end
